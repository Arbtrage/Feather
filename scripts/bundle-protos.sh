...
PY_DST="$ROOT/packages/sdk-python/arbitrage/feather/proto/feather"
...
GEN="$PY_SDK/arbitrage/feather/_gen"
rm -rf "$GEN"
mkdir -p "$GEN"

if python3 -c "import grpc_tools" 2>/dev/null; then
  python3 -m grpc_tools.protoc \
    -I"$PY_SDK/arbitrage/feather/proto" \
    --python_out="$GEN" \
    --grpc_python_out="$GEN" \
    "$PY_SDK/arbitrage/feather/proto/feather/v1/common.proto" \
    "$PY_SDK/arbitrage/feather/proto/feather/v1/job.proto" \
    "$PY_SDK/arbitrage/feather/proto/feather/v1/queue.proto" \
    "$PY_SDK/arbitrage/feather/proto/feather/v1/worker.proto"
